...
function empty(obj) {
    if (obj.innerText == "Type something here")
        obj.innerHTML= "";
    else
...
if (h > 0 && h < 12)
    ...
    var t= 12 + ":" + m + " am";           
document.getElementById("ctitle").innerHTML= months[x.getMonth()] + " " + x.getDate() + ", " + x.getFullYear();
document.getElementById("created").innerHTML= msg + " " + mnt + " " +dt + " " + yr + " at " + t;
